...
export class STAStarshipSheet2e extends ActorSheet {
  ...
  get template() {
    ...
    if (!foundry.utils.isNewerVersion(versionInfo,"0.8.-1")) return "systems/sta/templates/actors/starship-sheet-legacy.html";
    return `systems/sta/templates/actors/starship-sheet2e.html`;
  }
